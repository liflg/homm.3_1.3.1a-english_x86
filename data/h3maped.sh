...
# no idea why, but it helps to have sound on my x86_64 machine with Heretic 2
...
#	CMD_ARGS="$CMD_ARGS +set gl_driver /usr/lib32/libGL.so.1"
#fi

# Allows h3maped to find its files
PATH=$PATH:../
